...
public class PasswordUtils {
    ...
    public static final String DATASOURCE_MASTER_KEY_ENV = "BAIZE_FLOW_DATASOURCE_MASTER_KEY";
     ...
     * BAIZE_FLOW_DATASOURCE_MASTER_KEY from an external secret manager in production.
     */
